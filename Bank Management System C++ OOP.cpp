...
void authenticate() {
    try {
        ...
        if (verify() == 1) {
            ...
            throw runtime_error("Incorrect Username / Password !!!!");
        }
...
void srch(){ //module for searching account ( 2 types by number and name )
        ...
        void about(){
            ...
            cout<<"It is a Simple Bank Management System Project for our 2nd Semester based on C++ programming language.";
                    ...
                    design(65, 205);
                    gotoxy(48, 15);
                    cout<<"[1] .Samman Kalsoom";
                    gotoxy(48, 16);
                    cout<<"[2] .Nayyab Kanwal";
                    gotoxy(48, 17);
...
public:
    virtual void displayInfo() {
        // Print common account details
    }
};

class SavingsAccount : public record {
private:
    float interest_rate;

public:
    void displayInfo() override {
        record::displayInfo(); // Call base class function
    }
...
void bms::search_name() {
    ...
    if (z == 13)
        ...
        srch();}
void bms:: chkblnc(){ // module for checking account balance and ing it
    record rec;
    ifstream f;
    int a;
    gotoxy(27, 4);
